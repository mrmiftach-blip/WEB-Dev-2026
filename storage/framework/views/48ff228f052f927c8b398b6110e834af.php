...
<head>
    ...
    <title>WebDev 2025 <?php if(isset($title)): ?> - <?php echo e($title); ?> <?php endif; ?></title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('article_category.list')); ?>">Kategori</a>
                    </li>
                </ul>
            </div>
        </div>
...
<?php $component->withAttributes(['type' => 'danger']); ?>
            <?php echo e(session('errors')->first('alert')); ?>
...
<?php /**PATH C:\Users\Admin\Downloads\webdev afl2\resources\views\components\template.blade.php ENDPATH**/ ?>